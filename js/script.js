...
-1 == $.inArray('team-status', a) && -1 == $.inArray('team-status-toggle', a) && -1 == $(t.target).parents().index($('.team-status')) && 0 == $(t.target).parents('.team-status-toggle').length && e()
    ...
    {
//    alert(123);
//    var ci = 'sandip,pm,nb,ddnm,fkf';
//    alert(ci);
//    debugger;
//        //var cii = $.getJSON('../Reconciliation.ashx').val();
//    alert(var cii);

       for (var e = [], t = 'cit,iesm,hj,hj,kl,fg,uy'.split(','), a = 0; a < t.length; a++) 
    ...
    I = function () {
        $(document).ready(function () {
            ...
            var e = (new Date).setTime((new Date).getTime() + 5000),
            t = (new Date).setTime((new Date).getTime() + 15000);
        ...
        $('.knob').knob({
            ...
            draw: function () {
                if ('tron' == this.$.data('skin')) {
                    ...
                    this.o.cursor && (i = o - 0.3) && (o += 0.3),
                    this.o.displayPrevious && (e = this.startAngle + this.angle(this.v), this.o.cursor && (a = e - 0.3) && (e += 0.3), this.g.beginPath(), this.g.strokeStyle = this.pColor, this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, a, e, !1), this.g.stroke()),
                    this.g.beginPath(),
        ...
        function n() {
            ...
            var t = {
                enter: function (e, t, a, i) {
                    var o,
                    n,
                    r = xChart.visutils.getInsertionPoint(9),
                    s = i.map(function (e) {
    ...
    tt = function () {
        $('.sparkline').each(function () {
            ...
            a,
            i;
            return a = $(this).attr('data-color') || 'red',
            i = '18px',
            $(this).hasClass('big') && (t = '5px', e = '2px', i = '40px'),
            $(this).sparkline('html', {
                type: 'bar',
                barColor: Theme.colors[a],
                height: i,
                barWidth: t,
                barSpacing: e,
                zeroAxis: !1
        ...
        $('.linechart').each(function () {
            var e;
            return e = '18px',
            $(this).hasClass('linechart-lg') && (e = '30px'),
            $(this).sparkline('html', {
                type: 'line',
                height: e,
                width: '150px',
    ...
    at = function () {
        ...
        r = $('#calendar').fullCalendar({
            ...
            i.start = e,
                i.allDay = t,
                $('#calendar').fullCalendar('renderEvent', i, !0),
        ...
        events: [
                ...
                {
                    title: 'Long Event',
                    start: new Date(n, o, i - 5),
                    end: new Date(n, o, i - 2),
                    backgroundColor: Theme.colors.red
                },
                {
                    id: 999,
                    title: 'Repeating Event',
                    start: new Date(n, o, i - 3, 16, 0),
                    allDay: !1,
                ...
                },
                {
                    id: 999,
                    title: 'Repeating Event',
                    start: new Date(n, o, i + 4, 16, 0),
                    allDay: !1,
                    backgroundColor: Theme.colors.primary
                },
                {
                    title: 'Meeting',
                    start: new Date(n, o, i, 10, 30),
                    allDay: !1,
                    backgroundColor: Theme.colors.green
                },
                {
                    title: 'Lunch',
                    start: new Date(n, o, i, 12, 0),
                    end: new Date(n, o, i, 14, 0),
                    allDay: !1,
                    backgroundColor: Theme.colors.red
                },
                {
                    title: 'Birthday Party',
                    start: new Date(n, o, i + 1, 19, 0),
                    end: new Date(n, o, i + 1, 22, 30),
                    allDay: !1,
    ...
    ft = function () {
        ...
        function t() {
            ...
            $('#placeholder').bind('plotselected', function (a, n) {
                n.xaxis.to - n.xaxis.from < 0.00001 && (n.xaxis.to = n.xaxis.from + 0.00001),
                n.yaxis.to - n.yaxis.from < 0.00001 && (n.yaxis.to = n.yaxis.from + 0.00001),
                i = $.plot('#placeholder', e(n.xaxis.from, n.xaxis.to), $.extend(!0, {
            }, t, {
                xaxis: {
                    min: n.xaxis.from,
                    max: n.xaxis.to
...
return {
    init: function () {
        App.isPage('index') && (g(), tt(), ft(), lt('chat-window'), at(), bt()),
