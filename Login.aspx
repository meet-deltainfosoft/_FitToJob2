<%@ Page Title="Online Exam Login" Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login" %>
...
<body style="padding: 2.5em 0">
    ...
    <div id="Div1" class="div1">
        <form id="Form1" runat="server" method="get">
            <div id="login">
                <fieldset style="background-color: #FFFF; border-style: solid; box-shadow: 0px 1px 6px #37c1bb; border-radius:20px;">
                    ...
                    <asp:Button ID="cmdSubmit" runat="server" Text="Sign in" OnClick="cmdSubmit_Click"></asp:Button>
            ...
            <div class="banner" style="text-align: center; font-size: x-small">
                B-1010, Infinity Tower, S.G. Highway, Ahmedabad - 15, Gujarat. || <a href="http://SchooliERP.com/">www.SchooliERP.com</a>
            </div>
            <!-- end #content -->
        </form>
        <!-- end #footer -->
