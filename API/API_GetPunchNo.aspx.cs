...
public partial class API_API_GetPunchNo : System.Web.UI.Page
{
    ...
    public string selectdata(String RegistrationId)
    {
        ...
        try
        {
            ...
            da = _aPI_BLL.returnDataTable("select HODInterviewId,RegistrationId ,Name ,Remarks ,PunchNo ,PunchNoOn from HODInterViews " +
