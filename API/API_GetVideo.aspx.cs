...
public partial class API_API_GetVideo : System.Web.UI.Page
{
    ...
    public string selectdata(string RegistrationId)
    {
        ...
        try
        {
            da = _aPI_BLL.returnDataTable(" select Top 1 a.RegistrationId, replace(a.SelfIntroVideoPath, '" + ConfigurationSettings.AppSettings["FolderPath"] + "', '" + ConfigurationSettings.AppSettings["FolderPathShow"] + "') as SelfIntroVideoPath From RegistrationVerifications a " +
