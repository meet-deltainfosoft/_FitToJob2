...
public partial class API_API_GetInterViewFormDetails : System.Web.UI.Page
{
    ...
    public string selectdata(string RegistrationId)
    {
        ...
        try
        {
            da = _aPI_BLL.returnDataTable(" select Top 1 FullName ,RegistrationId , AadharCardNo ,PresentMobileNo  from vwInterviewFormDetails" +
