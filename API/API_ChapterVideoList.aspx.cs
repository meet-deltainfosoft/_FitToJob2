...
public partial class API_ChapterVideoList : System.Web.UI.Page
{
    string ChapterId;
    ...
    public string selectdata()
    {
        ...
        try
        {
            da = _aPI_BLL.returnDataTable(" select *, replace(VideoLink, 'https://vimeo.com/', '') as 'VideoID' " +
                                          " from ChapterVideos where ChapterId = '" + ChapterId.ToString() + "' and isnull(IsDisabled, 0) = 0 order by SrNo ");
