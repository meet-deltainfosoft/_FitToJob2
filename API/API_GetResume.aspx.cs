...
public partial class API_API_GetResume : System.Web.UI.Page
{
    ...
    public string selectdata(string RegistrationId)
    {
        ...
        try
        {
            da = _aPI_BLL.returnDataTable(" select Top 1 a.RegistrationId, replace(a.UplaodResume, '" + ConfigurationSettings.AppSettings["FolderPath"] + "', '" + ConfigurationSettings.AppSettings["FolderPathShow"] + "') as UplaodResume ,a.ResumeName From RegistrationVerifications a " +
