...
public partial class API_GetParams : System.Web.UI.Page
{
    ...
    public string selectdata()
    {
        ...
        try
        {
            da = _aPI_BLL.returnDataTable("select FacetText,FacetName From Facets where FacetName" +
            " in ('TakeSelfionSubmitAns','TakeSelfiOnStartQue') order by FacetName Asc");
