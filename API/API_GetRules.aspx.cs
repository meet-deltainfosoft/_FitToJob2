...
public partial class API_API_GetRules : System.Web.UI.Page
{
    string Group;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                ...
                Group = ((Request.Form["Group"] != null && Request.Form["Group"] != "") ? Request.Form["Group"].ToString() : null);
                ...
                Response.Write(selectdata(Group));
    ...
    public string selectdata(string Group)
    {
        ...
        try
        {
            da = _aPI_BLL.returnDataTable(" select T.TextListId ,T.[Text] as 'Rules' from TextLists T " +
                                          " where T.[Group] = '" + Group + "' order by T.[Text] ");
