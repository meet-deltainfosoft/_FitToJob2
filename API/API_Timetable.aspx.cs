...
public partial class API_Timetable : System.Web.UI.Page
{
    ...
    public string selectdata()
    {
        ...
        try
        {
            ...
            sqlCmd.Parameters.AddWithValue("@Action", "API_Timetable");
    ...
    public string selectdata_old()
    {
        ...
        try
        {
            ...
            da = _aPI_BLL.returnDataTable("Select E.ExamScheduleId,S.SubjectName,T.TestName QuestionLevel,E.TotalQuestions,E.TotalQuestions TotalMarks, T.TestId, s.subjectId as subId " +
            "From ExamScheduleLns EL Join ExamSchedules E on EL.ExamScheduleId = E.ExamScheduleId " +
            "Join Subjects S on E.SubId = S.subjectId Join Tests T on T.TestId = E.TestId " +
             "Where EL.RegistrationId =" + "'" + RegistrationId + "'" + " and ExamDate = convert(date,'" + Convert.ToDateTime(date).ToString("dd-MMM-yyyy") + "')   ");
