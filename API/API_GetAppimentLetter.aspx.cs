...
public partial class API_API_GetAppimentLetter : System.Web.UI.Page
{
    ...
    public string selectdata(string RegistrationId)
    {
        ...
        try
        {
            da = _aPI_BLL.returnDataTable(" select Top 1 Name , Remarks ,RegistrationId ,IsOfferLetter ,GOfferLetterOn  from HODInterViews" +
                                           " where IsOfferLetter ='A' " +
