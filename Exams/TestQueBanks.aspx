<%@ Page Language="C#" MasterPageFile="~/Delta_MCQ.master" AutoEventWireup="true"
    CodeFile="TestQueBanks.aspx.cs" Inherits="Exams_TestQueBanks" Title="Test from Pattern Filter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="form">
        ...
        <div class="formBody">
            <table border="0" cellspacing="0">
                <tr>
                    <td>
                        <asp:Label runat="server" ID="lblName" Text="Test Name Like:"></asp:Label>
                    </td>
                    <td>
    ...
    <div class="form">
        <div class="formHeader">
            Tests (List) &nbsp;&nbsp;&nbsp;<asp:Label runat="server" ID="lblRecordStatus"></asp:Label></div>
        <div class="formBody">
