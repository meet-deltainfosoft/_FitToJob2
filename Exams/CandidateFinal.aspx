<%@ Page Title="" Language="C#" MasterPageFile="~/Delta_MCQ.master" AutoEventWireup="true"
    CodeFile="CandidateFinal.aspx.cs" Inherits="Exams_CandidateFinal" %>
    ...
    <div class="form">
        ...
        <div class="formBody" style="overflow: auto; height: auto">
            <asp:GridView runat="server" ID="gdvInterview" AutoGenerateColumns="False" SkinID="Lns"
                ...
                <Columns>
                    <asp:HyperLinkField Text="Offer Letter" HeaderText="" Target="_blank" Visible="False">
                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                    </asp:HyperLinkField>
                     <asp:HyperLinkField Text="Appointment Letter" HeaderText="" Target="_blank" Visible="False">
                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                    </asp:HyperLinkField>
                    <asp:TemplateField HeaderText="Status">
                        ...
                        <ItemTemplate>
                            <asp:DropDownList runat="server" ID="ddlApprovedDisapproved" OnSelectedIndexChanged="ddlApprovedDisapproved_SelectedIndexChanged">
                                ...
                                <asp:ListItem Value="CP" Text="Candidate Pass"></asp:ListItem>
                                <asp:ListItem Value="CF" Text="Candidate Fail"></asp:ListItem>
                                <asp:ListItem Value="CH" Text="Candidate Hold"></asp:ListItem>
                                <asp:ListItem Value="HP" Text="HR Pass"></asp:ListItem>
                                <asp:ListItem Value="HF" Text="HR Fail"></asp:ListItem>
                                <asp:ListItem Value="HH" Text="HR Hold"></asp:ListItem>
                                <asp:ListItem Value="HOP" Text="HOD Pass"></asp:ListItem>
                                <asp:ListItem Value="HOF" Text="HOD Fail"></asp:ListItem>
                                <asp:ListItem Value="HOH" Text="HOD Hold"></asp:ListItem>
                                <asp:ListItem Value="FP" Text="Final Pass"></asp:ListItem>
                                <asp:ListItem Value="FF" Text="Final Fail"></asp:ListItem>
                                <asp:ListItem Value="FH" Text="Final Hold"></asp:ListItem>
                                <asp:ListItem Value="OP" Text="Offer Latter Pending"></asp:ListItem>
                                <asp:ListItem Value="OR" Text="Offer Latter Rejected"></asp:ListItem>
                                <asp:ListItem Value="OA" Text="Offer Latter Accepted"></asp:ListItem>
                                <asp:ListItem Value="AP" Text="Appointment Latter Pending"></asp:ListItem>
                                <asp:ListItem Value="AR" Text="Appointment Latter Rejected"></asp:ListItem>
                                <asp:ListItem Value="AA" Text="Appointment Latter Accepted"></asp:ListItem>
                                <asp:ListItem Value="T" Text="Training"></asp:ListItem>
                                <asp:ListItem Value="TP" Text="Training Pass"></asp:ListItem>
                                <asp:ListItem Value="PN" Text="Punch No."></asp:ListItem>
                            </asp:DropDownList>
