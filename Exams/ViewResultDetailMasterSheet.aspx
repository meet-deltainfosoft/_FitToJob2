<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewResultDetailMasterSheet.aspx.cs"
    Inherits="General_ViewResultDetailMasterSheet" Title="View Result Detail" %>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <h4>
                    <asp:Label runat="server" ID="lblCandidateName" Text="Dear " Visible="false"></asp:Label></h4>
            </div>
        </div>
        <div class="row" runat="server" id="divHead" visible="false">
            <div class="col-md-6 col-md-offset-3">
                <div class="row">
                    <div class="col-md-6">
                        <h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <h3>
                    <asp:Label runat="server" ID="lblMobileNo" Text="Mobile No : " Visible="false"></asp:Label></h3>
                <h4>
