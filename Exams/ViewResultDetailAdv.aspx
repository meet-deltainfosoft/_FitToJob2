<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewResultDetailAdv.aspx.cs"
    Inherits="General_ViewResultDetailAdv" Title="View Result Detail Advance" %>
    ...
    <div class="container">
        ...
        <div class="row text-center">
            <div class="col-md-6 col-md-offset-3">
                <div class="row">
                    <div class="col-sm-12">
                        <h4>
                            Result Detail Adv</h4>
                        <div class="pull-right">
                            <a class="btn btn-danger" href="ResultDetailAdv.aspx">Go Back</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <br />
                <h3>
                    <asp:Label runat="server" ID="lblErrorMessage" Text=""></asp:Label></h3>
            </div>
        </div>
        <div class="row" id="divHeaer" runat="server">
            <div class="col-md-6 col-md-offset-3">
                <div class="row">
                    <div class="col-md-6">
                        <h4>
                        ...
                        <h4>
                            <asp:Label runat="server" CssClass="text-danger" ID="lblNoOfUnAttemptedQuestions"
                                Text="Total No Of UnAttempted Questions : "></asp:Label></h4>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="row" id="divHeaer2" runat="server">
            <div class="col-md-6 col-md-offset-3">
                <h4>
