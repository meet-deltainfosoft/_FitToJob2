<%@ Page Title="Question" Language="C#" MasterPageFile="~/Delta_MCQ.master" AutoEventWireup="true"
    CodeFile="Que.aspx.cs" Inherits="Exams_Que" %>
                        ...
                        <table border="0" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                                ...
                                <td valign="top" colspan="4">
                                    ...
                                    <asp:RadioButton runat="server" ID="rbQueTypeFILE" Text="Question Image/Photo Upload"
                                        GroupName="QueType" AutoPostBack="true" OnCheckedChanged="rbQueTypeFILE_CheckedChanged" />
                            ...
                            <tr runat="server" id="trQueDataType">
                                <td valign="top">
                                    <asp:Label ID="lblQueDataType" runat="server" Text="Question Data Type :"></asp:Label>
                                </td>
                                <td valign="top" colspan="4">
                            ...
                            <tr>
                                ...
                                <td style="border-top: 1px black solid" colspan="4">
                                    <asp:TextBox runat="server" ID="txtRightMarks" Style="height: 20px" TabIndex="8"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top">
                                ...
                                <td colspan="4">
                                    <asp:TextBox runat="server" ID="txtWrongMarks" Style="height: 20px" TabIndex="9"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top">
                                ...
                                <td colspan="4">
                                    <asp:TextBox runat="server" ID="txtNonMarks" Style="height: 20px" TabIndex="10"></asp:TextBox>
                                </td>
                            </tr>
                            <tr runat="server" id="trNoOfSubQues">
                                <td valign="top">
                                    <asp:Label ID="lblNoOfSubQues" runat="server">No of Sub Questions :<em>*</em></asp:Label>
                                </td>
                                <td colspan="4">
                                    <asp:TextBox runat="server" ID="txtNoOfSubQues" Style="height: 20px" TabIndex="10"
                                        Text="1"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
            ...
            <table border="0" cellspacing="0">
                <tr>
                    ...
                    <td style="width: 686px" align="right">
                        <asp:Button ID="btnOK" runat="server" Text="OK" OnClick="btnOK_Click" TabIndex="11" />
