<%@ Page Title="Question Bank" Language="C#" MasterPageFile="~/Delta_MCQ.master"
    AutoEventWireup="true" CodeFile="QueBank.aspx.cs" Inherits="Exams_QueBank" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" src="../jQuery/Numeric/jquery.numeric.pack.js"></script>
    <script type="text/javascript" src="../jQuery/Autocomplete/jquery.autocomplete.pack.js"></script>
    <link type="text/css" href="../jQuery/Autocomplete/jquery.autocomplete.css" rel="Stylesheet" />
    <script src="../jQuery/jquery2.3.1.min.js" type="text/javascript"></script>
        ...
        <div class="formHeader">
            <table width="100%">
                <tr>
                    ...
                    <td align="right">
                        <asp:Label runat="server" Text="For More Mathematical Symbols Please "></asp:Label>
                        <asp:HyperLink runat="server" Target="_blank" Text="Click here" ForeColor="white"
                            NavigateUrl="http://xahlee.info/comp/unicode_math_operators.html"></asp:HyperLink>
                    </td>
                </tr>
            </table>
        </div>
                    ...
                    <td width="70%" valign="top">
                        <table border="0" cellspacing="0" cellpadding="5"> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="ddlPeriodNo" Width="200px" OnSelectedIndexChanged="ddlPeriodNo_SelectedIndexChanged"
                                        AutoPostBack="true">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td valign="top">
                                    <asp:Label ID="lblSrNo" runat="server" Text="Question No :<em>*</em>"></asp:Label>
                                </td>
                                <td valign="top">
                                ...
                                <td valign="top">
                                    <asp:Label runat="server" ID="lblHashTag" Text="HashTag:"></asp:Label>
                                </td>
                                <td valign="top">
                                    <asp:TextBox runat="server" ID="txtHashTag" Width="100px" Height="20px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top">
                                    <asp:Label ID="lblQueType" runat="server" Text="Question Type :<em>*</em>"></asp:Label>
                                </td>
                                <td valign="top" colspan="4">
                                    <asp:RadioButton runat="server" ID="rbQueTypeMCQ" Text="MCQ" GroupName="QueType"
                                        AutoPostBack="true" OnCheckedChanged="rbQueTypeMCQ_CheckedChanged" />
                                    <asp:RadioButton runat="server" ID="rbQueTypeNONMCQ" Text="Non - MCQ" GroupName="QueType"
                                        AutoPostBack="true" OnCheckedChanged="rbQueTypeNONMCQ_CheckedChanged" />
                                    <asp:RadioButton runat="server" ID="rbQueTypeFILE" Text="File Upload" GroupName="QueType"
                                        AutoPostBack="true" OnCheckedChanged="rbQueTypeFILE_CheckedChanged" />
                                    <asp:RadioButton runat="server" ID="rbQueTypeWholeQPaper" Text="Whole Question Paper"
                                        GroupName="QueType" AutoPostBack="true" OnCheckedChanged="rbQueTypeWholeQPaper_CheckedChanged" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td valign="top">
                                    <asp:Label ID="lblLevelOfQuestion" runat="server" Text="Level of Question: <em>*</em>"></asp:Label>
                                </td>
                                <td valign="top" colspan="4">
                                    <asp:RadioButton runat="server" ID="rbLevelOfQueEasy" Text="Easy" GroupName="LevelOfQue"
                                        Checked="true" />
                                    <asp:RadioButton runat="server" ID="rbLevelOfQueMedium" Text="Medium" GroupName="LevelOfQue" />
                                    <asp:RadioButton runat="server" ID="rbLevelOfQueHard" Text="Hard" GroupName="LevelOfQue" />
                                    <asp:RadioButton runat="server" ID="rbLevelOfQueChallenging" Text="Challenging" GroupName="LevelOfQue" />
                                </td>
                            </tr>
                            <tr runat="server" id="trQueDataType">
                                <td valign="top">
                                    <asp:Label ID="lblQueDataType" runat="server" Text="Question Data Type : <em>*</em>"></asp:Label>
                                </td>
                                <td valign="top" colspan="4">
                                    <asp:RadioButton runat="server" ID="rbQueDataTypeNum" Text="NUMERIC ONLY" GroupName="QueDataType" />
                                    <asp:RadioButton runat="server" ID="rbQueDataTypeChar" Text="CHARACTER + NUMARIC ONLY"
                                        GroupName="QueDataType" />
                                </td>
                            </tr>
                            <tr runat="server" id="trNoOfFileUpload">
                                <td valign="top">
                                    <asp:Label ID="lblNoOfFile" runat="server" Text="Question Data Type : <em>*</em>"></asp:Label>
                                </td>
                                <td valign="top" colspan="4">
                            ...
                            <tr runat="server" id="trQuestion">
                                <td style="border-top: 1px black solid" valign="top">
                                    <asp:Label ID="lblQue" runat="server" Text="Question:<em>*</em>"></asp:Label>
                                </td>
                                <td style="border-top: 1px black solid" valign="top" colspan="4">
                                    <asp:TextBox ID="txtQue" runat="server" Width="400px" TabIndex="2" Height="28px"
                            ...
                            <tr runat="server" id="trQuestion2">
                                <td valign="top" class="part">
                                    <asp:Label ID="lblBabyPics" runat="server" Text="Select Question Image: <span style='color:red;background-color:yellow'>[500 X 100 PIXEL]</span>"
                                    ...
                                    <div id="trQueTest" runat="server">
                                        ...
                                        <asp:Label ID="Label9" runat="server" Text="Paste Copied Question Image Here" Visible="true"></asp:Label>
                                        <div class="row" runat="server">
                                            <div class="que" runat="server" id="QueTest">
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td colspan="4" class="part" valign="top" runat="server" id="trTextarea1">
                                    <div class="span4">
                                        <br />
                            ...
                            <tr runat="server" visible="false">
                                <td style="border-top: 1px black solid" valign="top">
                                    <asp:Label ID="lblRightMarks" runat="server">Correct Answer Marks :<em>*</em></asp:Label>
                                </td>
                                <td style="border-top: 1px black solid" colspan="4">
                                    <asp:TextBox runat="server" ID="txtRightMarks" Style="height: 20px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr runat="server" visible="false">
                                <td valign="top">
                                    <asp:Label ID="lblWrongMarks" runat="server">Wrong Answer Marks :<em>*</em></asp:Label>
                                </td>
                                <td colspan="4">
                                    <asp:TextBox runat="server" ID="txtWrongMarks" Style="height: 20px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr runat="server" visible="false">
                                <td valign="top">
                                    <asp:Label ID="lblNonMarks" runat="server">Skipped Question Marks :<em>*</em></asp:Label>
                                </td>
                                <td colspan="4">
                                    <asp:TextBox runat="server" ID="txtNonMarks" Style="height: 20px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </td>
                    <td width="30%" valign="top">
                        <asp:Panel Style="overflow: auto;" runat="server">
                            <br />
                            <br />
                            <asp:PlaceHolder runat="server" ID="phdUnicode"></asp:PlaceHolder>
                        </asp:Panel>
                    </td>
                </tr>
            </table>
            ...
            <table border="0" cellspacing="0">
                <tr>
                    <td style="width: 90px" align="left">
                        ...
                        <asp:Button runat="server" ID="btnForceDelete" Text="Force Delete" OnClientClick="return confirm('Do you Want to Delete');"
                            OnClick="btnForceDelete_Click" />
                    </td>
