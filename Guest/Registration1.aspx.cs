    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                sqlCmd.Parameters.AddWithValue("@ResidentialPincode", txtresidentialPinCode.Text.Trim());
            ...
            try
            {
                ...
                if (dataSet.Tables[0].Rows.Count > 0)
                {
                    if (dataSet.Tables[0].Rows[0]["IsSuccessful"].ToString() == "1")
                    {
                        ...
                        txtresidentialPinCode.Text = dataSet.Tables[1].Rows[0]["ResidentialPincode"].ToString();
                        Registration1DTO _registrationDTO = new Registration1DTO();
                        _registrationDTO.IsNew = false;
                    }
                    else
