<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="Guest_ChangePassword" %>
    ...
    <div class="container mt-2 containerBorder align-items-center">
        ...
        <div class="row justify-content-left mt-4">
            <div class="col-lg-12 text-left">
                <asp:Label runat="server" ID="lblMobileNo" Text="Password*"></asp:Label>
            ...
            <div class="col-lg-12 text-left">
                <asp:Label runat="server" ID="Label1" Text="Confirm Password*"></asp:Label>
                <asp:TextBox runat="server" ID="txtChangePassword" CssClass="form-control" MaxLength="12"
                    placeholder="xxxxxxxxxx" TabIndex="1" onkeypress="return validateNumericInput(event);"
                    oninput="limitCharacters()" Style="color: #37C1BB"></asp:TextBox>
            </div>
        </div>
        <div class="row justify-content-center mt-3">
            <div class="col-lg-12 col-sm-12 text-left">
                <asp:LinkButton runat="server" ID="lnkChangePassword" CssClass="btn btn-info buttton" OnClick="lnkChangePassword_click">
