<%@ Page Title="" Language="C#" MasterPageFile="~/Delta_MCQ.master" AutoEventWireup="true"
    CodeFile="ChapterLinks.aspx.cs" Inherits="General_ChapterLinks" %>
        ...
        <div class="formBody" style="overflow: auto">
            <asp:GridView runat="server" ID="gdvChapterLink" AutoGenerateColumns="False" SkinID="Lns"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Link No" DataField="SrNo">
                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                        <ItemStyle Width="150px" HorizontalAlign="Left" VerticalAlign="Top" />
                    </asp:BoundField>
                    <asp:BoundField HeaderText="Link Name" DataField="LinkName">
                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                        <ItemStyle Width="150px" HorizontalAlign="Left" VerticalAlign="Top" />
                    </asp:BoundField>
