<%@ Page Title="" Language="C#" MasterPageFile="~/Delta_MCQ.master" AutoEventWireup="true"
    CodeFile="ChapterPDFs.aspx.cs" Inherits="General_ChapterPDFs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" src="../jquery.tablesorter/jquery.tablesorter-update.js"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            AddTHEAD("<%=gdvChapterPDF.ClientID%>");
            $("#<%=gdvChapterPDF.ClientID%>").tablesorter({ locale: 'en', widgets: ['zebra'] });
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="formBody">
            <table border="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="ddlChapter" AutoPostBack="true" Width="200px"
                            TabIndex="3" OnSelectedIndexChanged="ddlChapter_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <%--<td align="right" style="padding-left: 50px">
    ...
    <div class="form">
        <div class="formHeader">
            Chapter PDF (List) &nbsp;&nbsp;&nbsp;<asp:Label runat="server" ID="lblRecordStatus"></asp:Label></div>
        <div class="formBody" style="overflow: auto">
            <asp:GridView runat="server" ID="gdvChapterPDF" AutoGenerateColumns="False" SkinID="Lns"
                OnRowDataBound="gdvChapterPDF_RowDataBound" Width="100%">
                <Columns>
                    ...
                    <asp:BoundField HeaderText="PDF No" DataField="SrNo">
                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                        <ItemStyle Width="150px" HorizontalAlign="Left" VerticalAlign="Top" />
                    </asp:BoundField>
                    <asp:BoundField HeaderText="FileLink" DataField="FileLink">
                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                        <ItemStyle Width="150px" HorizontalAlign="Left" VerticalAlign="Top" />
                    </asp:BoundField>
