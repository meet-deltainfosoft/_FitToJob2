<%@ Page Title="" Language="C#" MasterPageFile="~/Delta_MCQ.master" AutoEventWireup="true"
    CodeFile="ChapterPDF.aspx.cs" Inherits="General_ChapterPDF" %>
                        ...
                        <div class="form">
                            <div class="formBody">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label runat="server" ID="lblSrNo" Text="PDF No. :<em>*</em>"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtSrNo"></asp:TextBox>
                                            &nbsp;
                                            <asp:HyperLink runat="server" ID="hlTest" Visible="false" Text="View Questions"></asp:HyperLink>
                                        </td>
                                    </tr>
                                    <tr>
