...
public class GeneralDAL
{
    ...
    public void OpenSQLConnection()
    {
       _sqlConn.ConnectionString = @"Persist Security Info=False;User ID=sa;Password=ERP@1234;Initial Catalog=MyTime_Organogram;Data Source=192.168.1.239\NEW2012"; // Live
        // _sqlConn.ConnectionString = @"Persist Security Info=False;User ID=sa;Password=sqlserver@123;Initial Catalog=MyTime_Organogram;Data Source=192.168.0.99\SQL2022"; // local
