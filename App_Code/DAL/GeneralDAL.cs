...
public class GeneralDAL
{
    ...
    {
       // _sqlConn.ConnectionString = @"Persist Security Info=False;User ID=sa;Password=ERP@1234;Initial Catalog=MyTime_Organogram;Data Source=192.168.1.239\NEW2012"; 
